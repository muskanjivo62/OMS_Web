...
export default function PersonWise_Report() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [selectedGroups, selectedStates, selectedUser, fromDate, toDate, orders]);
              ...
              <table className="dr-d-tbl">
                <thead>
                  <tr>
                    ...
                    <th>Scheme</th><th>Scheme Qty</th><th>Qty</th><th>Pcs</th><th>Boxes</th><th>Ltrs</th><th>Scheme Ltrs</th><th>Total Ltrs</th>
